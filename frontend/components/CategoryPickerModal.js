...
const CATEGORY_GROUPS = [
  {
    ...
    data: [
      ...
      { label: 'Business Income', value: 'Business Income', icon: 'briefcase-outline', color: '#f59e42' },
      { label: 'Other Income', value: 'Other Income', icon: 'add-circle-outline', color: '#6366f1' },
    ],
  },
  {
  ...
  },
  {
    ...
    data: [
      { label: 'Auto Payment', value: 'Auto Payment', icon: 'car-outline', color: '#8b5cf6' },
      { label: 'Public Transit', value: 'Public Transit', icon: 'bus-outline', color: '#0ea5e9' },
      { label: 'Gas', value: 'Gas', icon: 'flame-outline', color: '#f59e42' },
      { label: 'Auto Maintenance', value: 'Auto Maintenance', icon: 'build-outline', color: '#64748b' },
      { label: 'Parking & Tolls', value: 'Parking & Tolls', icon: 'pricetag-outline', color: '#f59e42' },
      { label: 'Taxi & Ride Shares', value: 'Taxi & Ride Shares', icon: 'car-sport-outline', color: '#14b8a6' },
    ],
  },
  {
    title: 'Housing',
    data: [
      ...
      { label: 'Home Improvement', value: 'Home Improvement', icon: 'hammer-outline', color: '#0ea5e9' },
    ],
  },
  {
    ...
    data: [
      ...
      { label: 'Gas & Electric', value: 'Gas & Electric', icon: 'flash-outline', color: '#f59e42' },
      { label: 'Internet & Cable', value: 'Internet & Cable', icon: 'wifi-outline', color: '#6366f1' },
  ...
  },
  {
    ...
    data: [
      ...
      { label: 'Restaurants & Bars', value: 'Restaurants & Bars', icon: 'wine-outline', color: '#f59e42' },
      { label: 'Coffee Shops', value: 'Coffee Shops', icon: 'cafe-outline', color: '#a855f7' },
    ],
  },
  {
    title: 'Travel & Lifestyle',
    data: [
      { label: 'Travel & Vacation', value: 'Travel & Vacation', icon: 'airplane-outline', color: '#14b8a6' },
      { label: 'Entertainment & Recreation', value: 'Entertainment & Recreation', icon: 'film-outline', color: '#ec4899' },
      { label: 'Personal', value: 'Personal', icon: 'person-outline', color: '#f43f5e' },
      { label: 'Pets', value: 'Pets', icon: 'paw-outline', color: '#f59e42' },
      { label: 'Fun Money', value: 'Fun Money', icon: 'happy-outline', color: '#22c55e' },
    ],
  },
  {
    title: 'Shopping',
    data: [
      ...
      { label: 'Clothing', value: 'Clothing', icon: 'shirt-outline', color: '#f472b6' },
      { label: 'Furniture & Housewares', value: 'Furniture & Housewares', icon: 'bed-outline', color: '#a855f7' },
  ...
  },
  {
    title: 'Children',
    data: [
      { label: 'Child Care', value: 'Child Care', icon: 'baby-outline', color: '#f59e42' },
      { label: 'Child Activities', value: 'Child Activities', icon: 'game-controller-outline', color: '#22c55e' },
    ],
  },
  {
    title: 'Education',
    data: [
      { label: 'Student Loans', value: 'Student Loans', icon: 'school-outline', color: '#6366f1' },
  ...
  },
  {
    title: 'Financial',
    data: [
      { label: 'Loan Repayment', value: 'Loan Repayment', icon: 'cash-outline', color: '#6366f1' },
      { label: 'Financial & Legal Services', value: 'Financial & Legal Services', icon: 'briefcase-outline', color: '#0ea5e9' },
      { label: 'Financial Fees', value: 'Financial Fees', icon: 'card-outline', color: '#f59e42' },
      { label: 'Cash & ATM', value: 'Cash & ATM', icon: 'cash-outline', color: '#22c55e' },
